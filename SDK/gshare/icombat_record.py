...
class CareerRecordMatchType(CareerRecordBase):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.icombat_record.CareerRecordHero'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class CareerRecordSeason(CareerRecordBase):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.icombat_record.CareerRecordMatchType'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class CombatRecordBrief(TeamCommonInfo):
    ...
    def _initProperty(self, data): ...
    @property
    def add_score(self): ...    @property
    def assists(self): ...    @property
    def damage(self): ...    @property
    def deads(self): ...    @property
    def enter_time(self): ...    @property
    def gain_coins(self): ...    @property
    def hero_id(self): ...    def items(self): ...
    def keys(self): ...
    @property
    def kills(self): ...    @property
    def legend_rank(self): ...    @property
    def qualifying_score(self): ...    @property
    def rank(self): ...    @property
    def self_gain_coins(self): ...    def setdefault(self, key, default): ...
    def show_memory_status(self): ...
    @property
    def streak_kills(self): ...    @property
    def team_scores(self): ...    def update2(self, data): ...
    def values(self): ...
...
class CombatRecordHistory(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomListTypeMetaClass = <class 'gshare.icombat_record.CombatRecordMatchType'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class CombatRecordMatchType(CustomListType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.icombat_record.CombatRecordBrief'>
...
class GunAchievements(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.icombat_record.GunCombatCounter'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class RankSummary(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.icombat_record.RankSummaryInfo'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class SummaryMatchType(CustomMapType):
    ...
    def _initProperty(self, data): ...
    @property
    def damage_per_combat(self): ...    def items(self): ...
    @property
    def kd(self): ...    def keys(self): ...
    def setdefault(self, key, default): ...
    def show_memory_status(self): ...
