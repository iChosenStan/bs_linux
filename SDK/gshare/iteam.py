...
class IHallGunParts(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.iteam.IHallGunPart'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class LeaveReason(enum):
    ...
    KICIOUT: int = 1
    SELF: int = 0
    name_to_values: dict = {'SELF': 0, 'KICIOUT': 1, 'DISMISS': 2, 'ERROR': 3}
    value_to_names: dict = {0: 'SELF', 1: 'KICIOUT', 2: 'DISMISS', 3: 'ERROR'}
...
class MatchState(enum):
    ...
    IDLE: int = 0
    MATCHING: int = 1
    name_to_values: dict = {'IDLE': 0, 'MATCHING': 1, 'FINISH': 2}
    value_to_names: dict = {0: 'IDLE', 1: 'MATCHING', 2: 'FINISH'}
...
class MoreTeamAgrees(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.iteam.MoreTeamAgree'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class ReserveType(enum):
    Invite: int = 1
    Join: int = 2
    name_to_values: dict = {'Invite': 1, 'Join': 2}
    value_to_names: dict = {1: 'Invite', 2: 'Join'}
...
class TeamReserves(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.iteam.ReserveInfo'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
