# module: gclient.gamesystem.entities.avatarmembers.cimp_daily_special_shop

import daily_special_refresh_data
import events
import six2

class CDailyItemInfo(ItemInfo):
    ...
    def direct_pkg_id(self): ...    @property
    def discount(self): ...    @property
    def discount_cost_count(self): ...    @property
    def is_direct_product(self): ...    @property
...
class CDailyItemInfoDict(ItemInfoDict):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gclient.gamesystem.entities.avatarmembers.cimp_daily_special_shop.CDailyItemInfo'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class CDailySpecialShop(IDailySpecialshop):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
...
class ItemInfoDict(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.idaily_special_shop.ItemInfo'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
