# module: gclient.gamesystem.entities.avatarmembers.cimp_gift_package
...
class CGiftPackage(GiftPackage):
    ...
    @property
    def item_info_list(self): ...    def items(self): ...
    @property
    def key_item_id(self): ...    def keys(self): ...
    def on_setattr(self, key, old, new): ...
    @property
    def price_value(self): ...    def setdefault(self, key, default): ...
    def show_memory_status(self): ...
    def update2(self, data): ...
    def values(self): ...

class CGiftPackageMgr(GiftPackageMgr):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gclient.gamesystem.entities.avatarmembers.cimp_gift_package.CGiftPackage'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class GiftPackageMgr(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.igift_package.GiftPackage'>
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    dsize: method_descriptor = <method 'dsize' of 'area_map' objects>
...
class GiftPackageState(enum):
    INIT: int = 1
    SHOWED: int = 2
    name_to_values: dict = {'INIT': 1, 'SHOWED': 2}
    value_to_names: dict = {1: 'INIT', 2: 'SHOWED'}
