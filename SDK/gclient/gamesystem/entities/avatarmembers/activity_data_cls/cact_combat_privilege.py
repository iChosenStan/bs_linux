# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_combat_privilege

import events
import six2
import task_gofunc_util

class ActCombatPrivileges(ActCommonData):
...
class CActCombatPrivilege(ActCombatPrivileges):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
