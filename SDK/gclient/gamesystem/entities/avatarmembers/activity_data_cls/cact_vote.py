# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_vote

import events

class ActDataMapType(CustomMapType):
...
class CActVoteData(VoteData):
    ...
    def setdefault(self, key, default): ...
    @property
    def shared(self): ...    def show_memory_status(self): ...
    def update2(self, data): ...
    def values(self): ...
...
class VoteData(ActivityDataBase):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
