# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_annual_pass
...
class ActAnnualPassData(ActivityDataBase):
...
class AnnualPassState(enum):
    DEFAULT: int = 0
    FINISH: int = 2
    PAYED: int = 1
    Refund: int = 3
    name_to_values: dict = {'DEFAULT': 0, 'PAYED': 1, 'FINISH': 2, 'Refund': 3}
    value_to_names: dict = {0: 'DEFAULT', 1: 'PAYED', 2: 'FINISH', 3: 'Refund'}
...
class CActAnnualPassData(ActAnnualPassData):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
...
class RewardRecord(CustomMapType):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
