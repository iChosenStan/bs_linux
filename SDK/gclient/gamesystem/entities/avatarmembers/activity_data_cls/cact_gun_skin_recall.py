# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_gun_skin_recall

import events

class ActGunSkinRecallData(ActivityDataBase):
    ...
    def AddDailyTasks(self, task_ids): ...
...
class CActGunSkinRecallData(ActGunSkinRecallData):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
