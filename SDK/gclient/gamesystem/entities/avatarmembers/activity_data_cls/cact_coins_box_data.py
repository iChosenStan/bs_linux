# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_coins_box_data

import events
import six2
import task_gofunc_util

OWN_CLIENT_PERSISTENT: int = 10

class ActCoinsBoxData(ActivityDataBase):
...
class BoxListType(CustomIntListType):
    IS_CUSTOM_TYPE: bool = True
...
class CActCoinsBoxData(ActCoinsBoxData):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
...
def on_box_list_change(self, *args): ...
