# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_blood_pass

import events

class ActBloodPassData(ActivityDataBase):
    ...
    def DoReward(self, index): ...
    def HasBitMark(self, bits, index): ...
    def HasReward(self, index): ...
...
class CActBloodPassData(ActBloodPassData):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
