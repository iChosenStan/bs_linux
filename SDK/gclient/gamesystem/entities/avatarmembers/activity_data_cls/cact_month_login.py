# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_month_login
...
class CActMonthLoginData(MonthLoginData):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
    ...
    def CanReward(self, day): ...
    def DoBitMark(self, bits, index): ...
    def DoReward(self, day): ...
    def HasBitMark(self, bits, index): ...
    def MarkDay(self, day): ...
    def _initProperty(self, data): ...
    @property
    def act_proto(self): ...    def can_reveive_any(self): ...
    @property
    def day_list(self): ...    def has_pass_on_day(self, day, today): ...
    def has_receive_all_my_login(self): ...
    def has_receive_on_day(self, day): ...
    def items(self): ...
    def keys(self): ...
    ...
    def show_memory_status(self): ...
    @property
    def today(self): ...    def update2(self, data): ...
    def values(self): ...
...
class MonthLoginData(ActivityDataBase):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
