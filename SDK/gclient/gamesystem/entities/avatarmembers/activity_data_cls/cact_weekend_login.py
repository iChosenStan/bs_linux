# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_weekend_login

import events

class ActWeekendLoginData(ActivityDataBase):
    ...
    def CheckHasRewarded(self, index): ...
...
class CActWeekendLoginData(ActWeekendLoginData):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
