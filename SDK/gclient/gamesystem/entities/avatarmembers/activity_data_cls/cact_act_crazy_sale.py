# module: gclient.gamesystem.entities.avatarmembers.activity_data_cls.cact_act_crazy_sale

import events
import six2
import switches

class ActCrazySaleData(ActivityDataBase):
    ...
    def InitShopData(self, target_id, item_dict, discount_int): ...
...
class CActCrazySaleData(ActCrazySaleData):
    IS_CUSTOM_TYPE: bool = True
    clear: method_descriptor = <method 'clear' of 'area_map' objects>
    copy: method_descriptor = <method 'copy' of 'area_map' objects>
    dict: method_descriptor = <method 'dict' of 'area_map' objects>
