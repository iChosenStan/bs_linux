# module: gclient.gamesystem.entities.avatarmembers.cimp_survey
...
SURVEYFROMTYPECOMBAT: int = 0
SURVEYFROMTYPEGUNSMITH: int = 1
...
class SurveyAct(CustomMapType):
    ...
    VALUE_TYPE: CustomMapTypeMetaClass = <class 'gshare.survey_util.SurveyInfo'>
