# module: gclient.gameplay.logic_base.entities.atm_entity
...
class ATM(CommonItem):
    ...
    logger: Logger = <Logger ATM (DEBUG)>
    ...
    def RefreshATMStatus(self, init=False): ...
    def ShowModel(self): ...
    ...
    @property
    def yaw(self): ...
class ATMModelComponent(CommonItemModelComponent):
    def BeforeDestroy(self): ...
    def CacheModel(self): ...
    def CreateCapsuleTrigger(self, radius, height, callback, filter_info, move_type=1, pos_height=None): ...
    def CreateTriggerRectangle(self, x, y, z, callback, is_trigger, move_type=1, offset=None): ...
