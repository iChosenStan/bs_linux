# module: gclient.gameplay.logic_base.entities.search_box
...
class CommonItem(ClientAreaEntity):
    ...
    @property
    def yaw(self): ...
class SearchContractBox(CommonItem):
    IsATM: bool = False
    IsATMGuardAI: bool = False
    IsAirDrop: bool = False
    IsAmmoBox: bool = False
    ...
    is_replay_avatar: bool = False
    is_replay_room: bool = False
    logger: Logger = <Logger SearchContractBox (DEBUG)>

    def BeforeDestroy(self): ...
    def CacheModel(self): ...
    def ClearLightEffect(self): ...
    def CreateCapsuleTrigger(self, radius, height, callback, filter_info, move_type=1, pos_height=None): ...
    def CreateToplogo(self): ...
    def CreateTriggerRectangle(self, x, y, z, callback, is_trigger, move_type=1, offset=None): ...
    def CreateTriggerSphere(self, radius, callback, is_trigger=True, local_trans=None): ...
    def DestroyExtra(self): ...
    def GetCollisionFilter(self): ...
    ...
    def GetUnitModelProto(self, model_id): ...
    def InitModel(self): ...
    def IsPlayerInOwnerTeam(self, player=None): ...
    @property
    def IsVisible(self): ...    def OnEnterSnare(self, player_avatar): ...
    def OnExitSnare(self, player_avatar): ...
    def OnModelLoad(self): ...
    def OnTriggerCb(self, trigger_info): ...
    def Open(self): ...
    def PlayLightEffect(self): ...
    def ShowHighLightEffect(self): ...
    def ShowModel(self): ...
    def _addComponent(component): ...
    def _callComponents(self, name, *args, **kwargs): ...
    def _delComponent(component): ...
    def _finiComponents(self): ...
    def _initComponents(self, bdict): ...
    def _on_set_is_opened(self, old): ...
    def _on_timer(self, timerid): ...
    def _orded_dispatch_rpc(self, method, *args): ...
    def _postComponents(self, bdict): ...
    def _tickComponents(self, dtime): ...
