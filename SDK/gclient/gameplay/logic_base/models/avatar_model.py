# module: gclient.gameplay.logic_base.models.avatar_model
...
ACTOR_VARIABLES_NEED_SYNC: list = ['ACTOR_TPS_IsDual', 'ACTOR_TPS_IKHand', 'ACTOR_TPS_HandIkEnable', 'ACTOR_TPS_Hand_IK_Bias', 'ACTOR_TPS_Hand_IK_Name', 'ACTOR_TPS_BotLookAtPitch']
CHARCTRL_POSE_HEIGHT: dict = {0: 0.8, 1: 0.3, 2: 0.8, 3: 0.3}
DEATH_POSE_TYPE: int = 2
FPS_LIMITS: dict = {1: 30.0, 2: 45.0, 3: 60.0}
GRAPH_DIR: str = 'Graph/'
LocalConfig: _LocalConfig = <gclient.config._LocalConfig object at 0x7040bf6d50>
ONETHIRD_PI: float = 1.046
QUAT_PI: float = 0.78
ResourceLoader: _ResourceLoader = <gclient.framework.util.resource_loader._ResourceLoader object at 0x7040c51950>
SHOW_SLIDE_JUMP_DEBUG: bool = False
...
class EmoteAvatarModelComp(object):
    def CreateEmoteShowModel(self): ...
    def CueStartShowEmoteModel(self): ...
    def CueStopShowEmoteModel(self): ...
    def OnEmoteWeaponModelLoaded(self, weapon_case): ...
...
class EmotePlayerAvatarModelComp(EmoteAvatarModelComp):
    def CreateEmoteShowModel(self): ...
...
class ModelHeroAttachComp(object):
    def CheckBodyAttachModel(self): ...
    def CheckHeroAttachModel(self): ...
    def HideHeroAttachModel(self, hide, hide_scabbard, hidden_reason): ...
    def OnBodyAttachModelDone(self): ...
